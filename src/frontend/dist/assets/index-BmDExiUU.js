...
const CloudDownload = createLucideIcon("cloud-download", __iconNode$a);
/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
function Toast({ message }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fixed bottom-24 left-1/2 -translate-x-1/2 bg-gray-800 text-white text-sm font-semibold px-5 py-3 rounded-full shadow-lg z-50 animate-fade-in", children: message });
}
function ConsultScreen() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col min-h-full", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-vospital-deep px-4 pt-4 pb-4 flex items-center justify-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-white font-bold text-xl", children: "Voice Consultation" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "span",
          {
            className: `w-2 h-2 rounded-full ${isOnline ? "bg-[#9BE28A] animate-pulse-dot" : "bg-red-400"}`
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "span",
          {
            className: `text-xs font-bold tracking-widest ${isOnline ? "text-[#9BE28A]" : "text-red-400"}`,
            children: isOnline ? "ONLINE" : "OFFLINE"
          }
        )
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 px-6 pt-10 pb-6 flex flex-col items-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative flex items-center justify-center mb-8", children: [
        isRecording && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute w-44 h-44 rounded-full bg-[#1B5E20]/20 animate-ping" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute w-52 h-52 rounded-full bg-[#1B5E20]/10 animate-ping [animation-delay:0.3s]" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsx(Mic, { className: "w-16 h-16 text-white", strokeWidth: 1.5 })
          }
        )
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-semibold text-gray-600 mb-8 h-5", children: isRecording ? "Listening..." : "Tap microphone to start" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full rounded-2xl bg-vospital-pale border border-vospital-primary/20 p-4 min-h-[130px] flex items-start", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-gray-400 italic", children: "Transcript will appear here..." }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full space-y-3 mt-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            type: "button",
...
function HomeScreen({ onNavigate }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col min-h-full", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 px-4 pt-4 pb-4 space-y-4 animate-fade-in", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white rounded-2xl shadow-card p-5 border-t-2 border-t-[#1B5E20]", children: [
...
function SyncScreen() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col min-h-full", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-vospital-deep px-4 pt-4 pb-4 flex items-center justify-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-white font-bold text-xl", children: "Sync Center" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "span",
          {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 px-4 pt-4 pb-6 space-y-5 animate-fade-in", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-gray-500 font-medium", children: "Last synced: Today 09:30" }),
      syncDone && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-green-50 border-y border-r border-green-200 border-l-4 border-l-green-600 rounded-xl p-4 flex items-center gap-3", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2", children: PENDING_ITEMS.map((item) => {
          ...
          return /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-2 h-2 rounded-full bg-amber-400 flex-shrink-0" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(Icon2, { className: "w-4 h-4 text-amber-500 flex-shrink-0" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-bold text-gray-900 text-sm", children: item.label }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-gray-500", children: "Pending upload" })
                ] })
              ] })
            },
            item.id
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          ...
          className: `w-full min-h-[52px] py-4 rounded-xl font-bold text-base flex items-center justify-center gap-2 transition-all ${isOnline && !isSyncing ? "bg-vospital-primary text-white hover:opacity-90 active:scale-[0.98]" : "bg-gray-200 text-gray-400 cursor-not-allowed"}`,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-bold text-gray-700 mb-2", children: "Completed" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2", children: COMPLETED_ITEMS.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
